      ...
      <div className="max-w-xl lg:max-w-3xl">
        <Link className="block text-blue-600" href="/">
          <span className="sr-only">Home</span>
            <Image src="/imgs/logo.svg" width={30} height={30} alt="logo image" className="rotate-45"/>
        </Link>

        <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
          Welcome to 🌞<span className="font-thin">&</span>🌕
        </h1>

        <p className="mt-4 leading-relaxed text-gray-500 capitalize font-bold">
         we are happy to have you as a part of our stsory 
        </p>
