...
import { removeProduct, selectCart, selectPrices } from '@/store/cartSlice';
...
{product.color !== '' ?<div>
                  <dt className="inline">Color:</dt><dd className="inline">{product.color}</dd>
                  </div>:null
}
              </dl>
            </div>
            ...
            <div className="flex flex-1 items-center justify-end gap-2">
              ...
              <button onClick={()=>dispatch(removeProduct({id:product.id,timeStamp:product.timeStamp}))} className="text-gray-600 transition hover:text-red-600">
